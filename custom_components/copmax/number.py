...
NUMBER_HEATPUMP: tuple[SensorEntityDescription, ...] = (
    ...
    #     register=30,
    #     type="SF",
    #     name="Ambient temp anti-freeze restart (@ST06)",
    #     min=-1.0,
    #     max=10.0,
    #     step=1,
    #     icon="mdi:temperature-celsius",
    ...
    #     register=31,
    #     type="SF",
    #     name="Ambient temp anti-freeze (cooling)",
    #     min=1.0,
    #     max=10.0,
    #     step=1,
    #     icon="mdi:temperature-celsius",
    ...
    #     register=32,
    #     type="SF",
    #     name="Ambient temp anti-freeze restart (@SF08)",
    #     min=1.0,
    #     max=10.0,
    #     step=1,
    #     icon="mdi:temperature-celsius",
    ...
    #     register=33,
    #     type="SF",
    #     name="Compat indoor and HW pump",
    #     min=0,
    #     max=1,
    #     step=1,
    #     icon="mdi:information",
